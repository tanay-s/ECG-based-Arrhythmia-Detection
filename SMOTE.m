function [final_features final_mark] = SMOTE(original_features, original_mark,factor)
...
I = nearestneighbour(T, X, 'NumberOfNeighbours', factor-1);
...
I = nearestneighbour(original_features', original_features', 'NumberOfNeighbours', factor-1);
I = I';
